<script>
	...
	function openModal () {
		showModal = true;
		document.body.style.filter = "blur(0.0rem)"
	}
	...
	<nav class="header-nav">
		<div class="header-div">
			<a href="/" class="flex items-center">
				<img src={logo} class="mr-3 h-12" alt="Logo">
			</a>
			<button on:click="{() => openModal()}" class="header-button">
				<svg class="fill-current" xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M6 36v-3h36v3Zm0-10.5v-3h36v3ZM6 15v-3h36v3Z"/></svg>
			</button>
			<div class="hidden w-full md:block md:w-auto">
				<ul class="header-ul">
					<li class="header-li" aria-current={$page.url.pathname === '/' ? 'page' : undefined}>
						<a href="/">Home</a>
					</li>
					...
					<li class="header-li">
						<div class="header-icon icon-sgv-header">
					...
					<li class="header-li">
						<a href="https://github.com/ruizdiazever" target="blank" class="header-icon icon-sgv-header">
	...
	<div>
		{#if showModal}
			<Modal on:close="{() => closeModal()}">
				<h2 slot="header" class="modal-header text-center" hidden>Menu</h2>
				<div class="flex justify-center">
					<div class="px-2 pt-10 header-li"><a href="/">Home</a></div>
					<div class="px-2 pt-10 header-li"><a href="/projects">Projects</a></div>
					<div class="px-2 pt-10 header-li"><a href="/docs">Docs</a></div>
					<div class="px-2 pt-10 header-li"><a href="/about">About</a></div>
				</div>
